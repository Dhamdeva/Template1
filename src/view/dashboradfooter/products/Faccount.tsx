    ...
    <div className="aadhaar">
      ...
      <div className="col-lg-10 mx-auto p-0 text-center mainpagehead">
        <Secondsildes
          ...
          imgh1={`𝗦𝗶𝗺𝗽𝗹𝗲 & 𝗲𝗮𝘀𝘆 𝘄𝗮𝘆 𝘁𝗼 𝘃𝗲𝗿𝗶𝗳𝘆 𝗯𝗮𝗻𝗸 𝗮𝗰𝗰𝗼𝘂𝗻𝘁`}
      ...
      <div className="col-lg-10 mx-auto text-center my-5">
        <Layout1
          layout1h5={`Bank Account Verification API
          `}
          layout1h2={`𝗩𝗲𝗿𝗶𝗳𝘆 𝗿𝗲𝗰𝗶𝗽𝗶𝗲𝗻𝘁 𝗮𝗰𝗰𝗼𝘂𝗻𝘁 𝗻𝘂𝗺𝗯𝗲𝗿 𝗯𝗲𝗳𝗼𝗿𝗲 𝗮𝗻𝘆 𝘁𝗿𝗮𝗻𝘀𝗮𝗰𝘁𝗶𝗼𝗻          `}
          line={"span mb-4"}
